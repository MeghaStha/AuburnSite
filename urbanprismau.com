...
var opensdg = {
  ...
  remoteDataBaseUrl: 'https://meghastha.github.io/AuburnAldataRepo/en',
...
var translations = {
  ...
  t: function(key) {
    ...
    <title>This is my example title - Indicators For The Sustainable Development Goals</title>
        ...
        <!--[if IE 9]>
        <script src="/AuburnSite/assets/js/lib/classList.js"></script>
        <![endif]-->

        <link rel="apple-touch-icon" sizes="180x180" href="/AuburnSite/assets/img/favicons/apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="/AuburnSite/assets/img/favicons/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="/AuburnSite/assets/img/favicons/favicon-16x16.png">
<link rel="icon" type="image/x-icon" href="/AuburnSite/assets/img/favicons/favicon.ico" />
        ...
        <!--[if IE]>
        <link rel="stylesheet" href="/AuburnSite/assets/css/ie.css">
        <![endif]-->
...
<div class="container">
  <div class="disclaimer-alert">
    ...
    This is a development website. We welcome your <a href="mailto:%email_address">feedback</a>.
...
<header role="banner" class="">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light flex-wrap align-items-start">
            <a class="navbar-brand" href="/AuburnSite/" id="home" aria-label="" title="">
    <img src="/AuburnSite/assets/img/SDG_logo.png" alt="Sustainable Development Goals - 17 Goals to Transform our World" />
</a>
    ...
    <a class="nav-link" href="/AuburnSite/goals">Goals</a>
</li><li class="nav-item ">
    <a class="nav-link" href="/AuburnSite/reporting-status">Reporting Status</a>
</li><li class="nav-item ">
    <a class="nav-link" href="/AuburnSite/about">About</a>
</li><li class="nav-item ">
    ...
    <a class="nav-link" href="/AuburnSite/my-example-page/">ArcGIS Online Maps</a>
                ...
                <div class="header-search-bar">
                    <form class="align-self-lg-end" id="search" action="/AuburnSite/search/">
...
<div class="container">
    ...
    <ol aria-label="breadcrumb" class="breadcrumb" style="--bs-breadcrumb-divider: '&rsaquo;';">
        <li class="breadcrumb-item" >
            <a href="/AuburnSite/">Home</a>
        </li>
        <li class="breadcrumb-item active">This is my example title</li>
    </ol>
</nav>
</div>
<div id="main-content" class="container" role="main">
    <div>
        <h1>This is my example title</h1>
            ...
            <div class="col">
                <div id="footerLinks">
                    <ul>
                        ...
                        <li>
                            <a href="/AuburnSite/contact-us">Contact us</a>
                            
                        </li>
                        <li>
                            
                            <a href="https://urbanprismau.com/" target="_blank">general.Website</a>
                            
                        </li>
                        <li>
                            <a href="/AuburnSite/about/cookies-and-privacy/">Cookies</a>
                        ...
                        <li>
                            <a href="/AuburnSite/config">Configuration</a>
                        </li>
                        </ul>
                </div>
            </div>
